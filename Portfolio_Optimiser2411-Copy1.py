 ...
 "cells": [
  {
   ...
   "metadata": {},
   "source": [
    "### Grabbing Data From Yahoo Finance For Stock Build last updated 24/11/2025"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "Tickers loaded from sheet: ['A200.AX', 'ACDC.AX', 'AT1.AX', 'BBUS.AX', 'BEAR.AX', 'BHP.AX', 'BLOK', 'CBA.AX', 'CSL.AX', 'ETHI.AX', 'FMG.AX', 'GME', 'LKE.AX', 'MQG.AX', 'MTUM.AX', 'NDQ.AX', 'PNV.AX', 'QLTY.AX', 'QUAL.AX', 'SMH', 'SMLL.AX', 'SPY', 'VDHG.AX', 'VLUE.AX', 'VMIN.AX', 'VSO.AX', 'VVLU.AX', 'WDS.AX', 'WTC.AX', 'YMAX.AX', '^AORD']\n",
  ...
  },
  {
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Using FX-adjusted returns for Sigma?: True (max |diff|=3.47e-18)\n",
      "[frontier] MVP return ≈ 0.1639, vol ≈ 0.0375 (MVP SLSQP success)\n",
      "[frontier] target_returns from 3.6000% to 29.1704%\n",
      "[frontier] tangency ret ≈ 0.2513, vol ≈ 0.0475\n",
      "\n",
      "=== LOTS_DF HEAD ===\n",
      "   Security    AcqDate  Units  CostBaseAUD\n",
      "0    LKE.AX 2025-11-14  12146     0.057000\n",
      "1    VSO.AX 2025-11-21     41    74.419998\n",
      "2   ACDC.AX 2025-11-21      5   130.320007\n",
      "3    NDQ.AX 2025-11-21      6    55.169998\n",
      "4    VSO.AX 2025-11-21     15    74.419998\n",
      "5   QLTY.AX 2025-11-21     25    32.419998\n",
      "6   A200.AX 2025-11-21     41   140.929993\n",
      "7   ACDC.AX 2025-11-21     51   129.500000\n",
      "8   BEAR.AX 2025-11-21    382     7.650000\n",
      "9    CBA.AX 2025-11-21     40   153.059998\n",
      "10   CSL.AX 2025-11-21      9   178.850006\n",
      "11  ETHI.AX 2025-11-21    364    16.190001\n",
      "12   MQG.AX 2025-11-21     22   194.089996\n",
      "13  MTUM.AX 2025-11-21    183    28.510000\n",
      "14   NDQ.AX 2025-11-21     95    55.070000\n",
      "15  QLTY.AX 2025-11-21    214    32.330002\n",
      "16  QUAL.AX 2025-11-21     98    60.900002\n",
      "17  SMLL.AX 2025-11-21    354     4.460000\n",
      "18  VDHG.AX 2025-11-21    105    71.910004\n",
      "19  VLUE.AX 2025-11-21    224    31.590000\n",
      "\n",
      "--- DEBUG CHECK: Sigma_opt / mu_vec_opt ---\n",
      "Any NaN in Sigma_opt: False\n",
      "Any NaN in mu_vec_opt: False\n",
      "Min variance: 4.064568747902629e-05\n",
      "Number of assets: 30\n",
      "Security   A200.AX   ACDC.AX    AT1.AX   BBUS.AX   BEAR.AX    BHP.AX  \\\n",
      "Security                                                               \n",
      "A200.AX   0.000059  0.000004  0.000003 -0.000007 -0.000003  0.000004   \n",
      "ACDC.AX   0.000004  0.000173  0.000010 -0.000011 -0.000003  0.000007   \n",
      "AT1.AX    0.000003  0.000010  0.002607 -0.000014 -0.000001  0.000013   \n",
      "BBUS.AX  -0.000007 -0.000011 -0.000014  0.000647  0.000006 -0.000011   \n",
      "BEAR.AX  -0.000003 -0.000003 -0.000001  0.000006  0.000061 -0.000003   \n",
      "\n",
      "Security      BLOK    CBA.AX    CSL.AX   ETHI.AX  ...   SMLL.AX       SPY  \\\n",
      "Security                                          ...                       \n",
      "A200.AX   0.000015  0.000002 -0.000004  0.000003  ...  0.000002  0.000009   \n",
      "ACDC.AX   0.000011  0.000002 -0.000008  0.000005  ...  0.000003  0.000011   \n",
      "AT1.AX   -0.000057 -0.000002 -0.000014  0.000008  ...  0.000003 -0.000018   \n",
      "BBUS.AX  -0.000011 -0.000005  0.000009 -0.000009  ... -0.000005 -0.000010   \n",
      "BEAR.AX  -0.000017 -0.000002  0.000003 -0.000003  ... -0.000002 -0.000010   \n",
      "\n",
      "Security   VDHG.AX   VLUE.AX       VMIN.AX    VSO.AX   VVLU.AX    WDS.AX  \\\n",
      "Security                                                                   \n",
      "A200.AX   0.000002  0.000004  7.155669e-07  0.000003  0.000005  0.000003   \n",
      "ACDC.AX   0.000004  0.000008  9.405550e-07  0.000005  0.000009  0.000005   \n",
      "AT1.AX    0.000004  0.000012  1.157764e-06  0.000007  0.000013  0.000006   \n",
      "BBUS.AX  -0.000007 -0.000013 -2.907471e-06 -0.000008 -0.000015 -0.000008   \n",
      "BEAR.AX  -0.000002 -0.000004 -7.257527e-07 -0.000003 -0.000005 -0.000003   \n",
      "\n",
      "Security    WTC.AX   YMAX.AX  \n",
      "Security                      \n",
      "A200.AX   0.000002  0.000003  \n",
      "ACDC.AX   0.000002  0.000004  \n",
      "AT1.AX   -0.000004  0.000001  \n",
      "BBUS.AX  -0.000001 -0.000006  \n",
      "BEAR.AX  -0.000002 -0.000003  \n",
      "\n",
      "[5 rows x 30 columns]\n",
      "Security\n",
      "A200.AX    0.197390\n",
      ...
      "max       1.077140\n",
      "dtype: float64\n",
      "Sigma diag min/max: 4.064568747902629e-05 0.005791761504986858\n",
      "Mkt-RF    0.221895\n",
      "SMB      -0.052655\n",
      "HML       0.033095\n",
      "RMW      -0.017655\n",
   ...
   "source": [
    ...
    "def _solve_frontier_point(mu_vec_opt, Sigma_opt, target_return):\n",
    "    \"\"\"\n",
    "    Solve a single point on the long-only efficient frontier:\n",
    "        minimise w' Σ w   subject to:\n",
    "            1) sum(w) = 1\n",
    "            2) w >= 0\n",
    "            3) w' μ = target_return\n",
    "    Returns:\n",
    "        w (array), ok (bool), note (str)\n",
    "    \"\"\"\n",
    "\n",
    "    # Convert inputs\n",
    ...
    "        return np.full(n, np.nan), False, f\"SLSQP failed ({res.message})\"\n",
    "\n",
    ...
    "        method=\"SLSQP\",\n",
    "        bounds=bounds,\n",
    "        constraints=cons_mvp,\n",
    "        options={\"maxiter\": 1000, \"ftol\": 1e-9},\n",
    "    )\n",
    "\n",
    "    if res_mvp.success and res_mvp.x is not None and np.all(np.isfinite(res_mvp.x)):\n",
    "        w_mvp = res_mvp.x\n",
    "        mvp_note = \"MVP SLSQP success\"\n",
    "    else:\n",
    "        # Fallback: equal weights\n",
    "        w_mvp = w0\n",
    "        mvp_note = f\"MVP fallback: {res_mvp.message if hasattr(res_mvp, 'message') else 'unknown'}\"\n",
    "\n",
    "    R_mvp_daily = float(mu @ w_mvp)\n",
    "    sigma_mvp_ann = float(np.sqrt(w_mvp @ S @ w_mvp) * np.sqrt(252.0))\n",
    "    R_mvp_ann = R_mvp_daily  # our μ is already annualised\n",
    "\n",
    "    print(f\"[frontier] MVP return ≈ {R_mvp_ann:.4f}, vol ≈ {sigma_mvp_ann:.4f} ({mvp_note})\")\n",
    "\n",
    ...
    "        w, ok, note = _solve_frontier_point(mu_vec_opt, Sigma_opt, R)\n",
    "        weights_dict[R] = w\n",
    "\n",
    ...
    "    mu_vec_opt,\n",
    "    Sigma_opt,\n",
    "    target_returns=None,   # let the function choose MVP-centred grid\n",
    "    n_points=20,\n",
    ...
    "    return t\n",
    "\n",
    "def _solve_frontier_point(mu_vec_opt: pd.Series,\n",
    "                          Sigma_opt: pd.DataFrame,\n",
    "                          target_return: float) -> tuple[np.ndarray, bool, str]:\n",
    "    \"\"\"\n",
    "    Pure Markowitz solver for a single frontier point:\n",
    "      minimise w'Σw\n",
    "      s.t.  sum(w) = 1\n",
    "           μ·w >= target_return\n",
    "\n",
    "    This deliberately ignores CGT / brokerage and current holdings.\n",
    "    \"\"\"\n",
    "    mu = mu_vec_opt.reindex(Sigma_opt.index).to_numpy(dtype=float)\n",
    "    S  = Sigma_opt.to_numpy(dtype=float)\n",
    "    n  = len(mu)\n",
    "\n",
    "    # Objective: portfolio variance (daily)\n",
    ...
    "        # weights sum to 1\n",
    "        {\"type\": \"eq\", \"fun\": lambda w: np.sum(w) - 1.0},\n",
    "        # expected return at least target_return (inequality for robustness)\n",
    "        {\"type\": \"ineq\", \"fun\": lambda w, mu=mu, R=target_return: float(mu @ w) - float(R)},\n",
    "    )\n",
    "\n",
    "    bounds = [(0.0, 1.0)] * n\n",
    "    w0 = np.full(n, 1.0 / n)\n",
    ...
    "\n",
    "    if (not res.success) or (res.x is None) or (not np.all(np.isfinite(res.x))):\n",
    "        note = f\"frontier SLSQP failed: {res.message}\"\n",
    "        w = np.full(n, np.nan)\n",
    "        ok = False\n",
    "    else:\n",
    "        note = \"frontier SLSQP success\"\n",
    "        w = res.x\n",
    "        ok = True\n",
    "\n",
    "    return w, ok, note\n",
    ...
    "    \"\"\"\n",
    "    Simple heuristic:\n",
    "    - Maximise expected return per factor unit\n",
    "    - Penalise instability via factor variance\n",
    "    \"\"\"\n",
    "    # Expected annualised premium / volatility\n",
    "    scores = f_mean_ann / np.sqrt(np.diag(Fcov_daily))\n",
    "\n",
    "    # Force into Series\n",
    "    scores = pd.Series(scores).reindex(f_mean_ann.index)\n",
    "\n",
    "    # Normalise to sum absolute = 1\n",
    "    norm = scores.abs().sum()\n",
    "    if norm == 0:\n",
    "        rec = scores*0\n",
    "    else:\n",
  ...
  },
  {
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "DEBUG: entering Block 7…\n",
      "[seed-path] holdings: rows=31, nonzero=23\n",
      "[chart] Skipping chart update: name 'update_efficient_frontier_chart' is not defined\n",
      "1 name: Chart 1 | title: Efficient Frontier & CAL (rf={rf_label})\n",
      "2 name: Chart 2 | title: Efficient Frontier & CAL (rf=4.00%)\n",
      "3 name: Chart 3 | title: Efficient Frontier & CAL (rf=3.60%)\n",
      "\n",
      "=== DEBUG FIRST NONZERO TRADE (inside make_trade_plan) ===\n",
      "  Security  Curr Units  Target Units  Δ Units  Last Px (AUD)  Cash Flow (AUD)\n",
      "0  A200.AX          66            78       12     142.199997     -1706.399963\n",
      "\n",
      "=== LOTS_DF HEAD ===\n",
      "   Security    AcqDate  Units  CostBaseAUD\n",
      "0    LKE.AX 2025-11-14  12146     0.057000\n",
      ...
      "0   ACDC.AX 2025-11-21          5  130.320007   651.600037     130.350006   \n",
      "1   ACDC.AX 2025-11-21         12  129.500000  1554.000000     130.350006   \n",
      "2   BEAR.AX 2025-11-21        373    7.650000  2853.450036       7.570000   \n",
      "3    CBA.AX 2025-11-21          9  153.059998  1377.539978     153.990005   \n",
      "4    CSL.AX 2025-11-21          4  178.850006   715.400024     181.500000   \n",
      "5   ETHI.AX 2025-11-21          8   16.190001   129.520004      16.320000   \n",
      "6    MQG.AX 2025-11-21         11  194.089996  2134.989960     194.130005   \n",
      "7   MTUM.AX 2025-11-21        103   28.510000  2936.530024      28.790001   \n",
      "8    NDQ.AX 2025-11-21          6   55.169998   331.019989      55.639999   \n",
      "9    NDQ.AX 2025-11-21         28   55.070000  1541.959991      55.639999   \n",
      "10   PNV.AX 2025-11-21        494    1.130000   558.219998       1.172000   \n",
      "11  QUAL.AX 2025-11-21          8   60.900002   487.200012      61.669998   \n",
      "12  SMLL.AX 2025-11-21        354    4.460000  1578.840014       4.530000   \n",
      "13  SMLL.AX 2025-11-24        298    4.500000  1341.000000       4.530000   \n",
      "14   VSO.AX 2025-11-21          6   74.419998   446.519989      75.519997   \n",
      "15  VVLU.AX 2025-11-21         14   76.830002  1075.620026      78.309998   \n",
      "16  YMAX.AX 2025-11-21        235    7.260000  1706.100054       7.300000   \n",
      "\n",
      "    Cash Flow (AUD)  Brokerage (AUD)  RealisedGain  \n",
      "0       2204.950104             11.0      0.149994  \n",
      "1       2204.950104             11.0     10.200073  \n",
      "2       2812.610064             11.0    -29.839972  \n",
      "3       1374.910049             11.0      8.370071  \n",
      "4        715.000000             11.0     10.599976  \n",
      "5        119.559998             11.0      1.039993  \n",
      "6       2124.430054             11.0      0.440094  \n",
      "7       2954.370094             11.0     28.840071  \n",
      "8       1880.759979             11.0      2.820007  \n",
      "9       1880.759979             11.0     15.959991  \n",
      "10       567.968025             11.0     20.748027  \n",
      "11       482.359985             11.0      6.159973  \n",
      "12      2942.560137             11.0     24.780061  \n",
      "13      2942.560137             11.0      8.940063  \n",
      "14       442.119980             11.0      6.599991  \n",
      "15      1085.339966             11.0     20.719940  \n",
      "16      1704.500045             11.0      9.399991  \n",
      "[debug] Current totals → Portfolio: 155293.45, Net Invested: 155574.84\n",
      "[debug] Previous totals → Portfolio: 155273.67, Net Invested: 155500.52\n",
      "[debug] Saved new state → Portfolio: 155293.45, Net Invested: 155574.84\n",
      ...
      "dtype: float64\n",
      "\n",
      "Min mu: -0.5451314142541549\n",
      "Max mu: 1.0771400372814148\n",
      "Mean mu: 0.21848481918575413\n",
   ...
   "source": [
    ...
    "                top  = opt.range(f\"A{start_s_row}\").api.Top\n",
    "                width = 480\n",
    "                height = 245\n",
    "            \n",
    ...
    "            chart_obj.Top    = opt.range(f\"A{start_s_row}\").api.Top\n",
    "            chart_obj.Width  = 480\n",
