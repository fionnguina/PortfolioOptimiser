 ...
 "cells": [
  {
   ...
   "metadata": {},
   "source": [
    "# Grabbing Data From Yahoo Finance For Stock Build last updated 30/12/2025"
   ]
  },
  {
   "cell_type": "markdown",
  ...
  },
  {
   ...
   "source": [
    ...
    "    if not bool(globals().get(\"OPEN_AFTER_SAVE\", True)):\n",
    "        return\n",
    "\n",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Using FX-adjusted returns for Sigma?: True (max |diff|=3.52e-19)\n",
      "[frontier] target_returns from 3.6000% to 35.5060%\n",
      "[frontier] tangency ret ≈ 0.2207, vol ≈ 0.0369\n",
      "\n",
      "--- DEBUG CHECK: Sigma_opt / mu_vec_opt ---\n",
      "Any NaN in Sigma_opt: False\n",
      "Any NaN in mu_vec_opt: False\n",
      "Min variance: 3.976843651871007e-05\n",
      "Number of assets: 22\n",
      "Security       A200.AX        IEU.AX    IJP.AX        IOO.AX        IVV.AX  \\\n",
      "Security                                                                     \n",
      "A200.AX   5.771624e-05  2.620065e-07  0.000004  1.317357e-06  1.439103e-06   \n",
      "IEU.AX    2.620065e-07  4.718416e-05  0.000002  4.030734e-07  2.784523e-07   \n",
      "IJP.AX    3.819718e-06  1.877490e-06  0.000145  4.624882e-06  4.600286e-06   \n",
      "IOO.AX    1.317357e-06  4.030734e-07  0.000005  8.804148e-05  2.040604e-06   \n",
      "IVV.AX    1.439103e-06  2.784523e-07  0.000005  2.040604e-06  8.213748e-05   \n",
      "\n",
      "Security       MTUM.AX        MVW.AX       QHAL.AX       QLTY.AX  \\\n",
      "Security                                                           \n",
      "A200.AX   2.000179e-06  7.318110e-07  1.157879e-06  1.478407e-06   \n",
      "IEU.AX    6.984428e-07 -1.222807e-07  2.319032e-07  5.430294e-07   \n",
      "IJP.AX    7.269893e-06  5.026522e-07  2.513997e-06  5.831363e-06   \n",
      "IOO.AX    2.290703e-06  9.381184e-07  1.718253e-06  1.932047e-06   \n",
      "IVV.AX    2.125545e-06  1.662015e-06  1.838784e-06  2.144569e-06   \n",
      "\n",
      "Security       QUAL.AX  ...       SPY        VAS.AX       VDHG.AX  \\\n",
      "Security                ...                                         \n",
      "A200.AX   2.238483e-06  ...  0.000007  1.296494e-06  1.044460e-06   \n",
      "IEU.AX    8.791658e-07  ...  0.000004  2.931649e-07  2.305059e-07   \n",
      "IJP.AX    9.129919e-06  ...  0.000035  3.968090e-06  3.052119e-06   \n",
      "IOO.AX    3.105708e-06  ...  0.000005  1.325401e-06  1.290871e-06   \n",
      "IVV.AX    3.441318e-06  ...  0.000002  1.444185e-06  1.462187e-06   \n",
      "\n",
      "Security        VGE.AX        VGS.AX       VLU       VLUE.AX       VMIN.AX  \\\n",
      "Security                                                                     \n",
      "A200.AX   2.466152e-08  1.343972e-06  0.000008  2.003564e-06  4.542681e-07   \n",
      "IEU.AX    3.104930e-07  4.063119e-07  0.000005  9.848604e-07 -1.111230e-07   \n",
      "IJP.AX    1.288334e-06  4.929840e-06  0.000040  9.283044e-06 -6.349417e-08   \n",
      "IOO.AX   -4.237438e-07  1.861253e-06  0.000006  2.888028e-06  5.171873e-07   \n",
      "IVV.AX   -8.727381e-07  2.141536e-06  0.000004  3.165203e-06  7.893479e-07   \n",
      "\n",
      "Security        VSO.AX       VVLU.AX  \n",
      "Security                              \n",
      "A200.AX   5.879878e-07  2.480658e-06  \n",
      "IEU.AX    1.555730e-08  9.544466e-07  \n",
      "IJP.AX    5.678532e-07  1.021662e-05  \n",
      "IOO.AX    3.979713e-07  3.191284e-06  \n",
      "IVV.AX    5.537899e-07  3.645368e-06  \n",
      "\n",
      "[5 rows x 22 columns]\n",
      "Security\n",
      "A200.AX    0.132275\n",
      ...
      "max       0.537064\n",
      "dtype: float64\n",
      "Sigma diag min/max: 3.976843651871007e-05 0.000686656125203294\n",
      "Mkt-RF    0.188673\n",
      "SMB      -0.050877\n",
      "HML       0.013623\n",
      "RMW      -0.053427\n",
  ...
  },
  {
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "[debug] tilt_point=(0.1469492803550686, 0.2783660079912484), factor_point=None\n",
      "1 name: Chart 1 | title: Efficient Frontier\n",
      "\n",
      "=== LOT-EXPANDED TABLE ===\n",
      "  Security    AcqDate  UnitsSold    AcqPrice    CostBase  Last Px (AUD)  \\\n",
      "0   IJP.AX        NaT          1         NaN         NaN     120.250000   \n",
      "1   IOO.AX 2025-12-15          1  187.369995  187.369995     187.600006   \n",
      "2   IVV.AX 2025-12-15          1   68.699997   68.699997      68.489998   \n",
      "3  QUAL.AX 2025-12-15          1   61.880001   61.880001      61.939999   \n",
      "4   VGS.AX 2025-12-15          1  153.729996  153.729996     153.899994   \n",
      "5  VLUE.AX 2025-11-21          1   31.590000   31.590000      33.540001   \n",
      "\n",
      "   Cash Flow (AUD)  Brokerage (AUD)  RealisedGain  \n",
      "0      -120.250000             11.0           NaN  \n",
      "1      -187.600006             11.0      0.230011  \n",
      "2       -68.489998             11.0     -0.209999  \n",
      "3       -61.939999             11.0      0.059998  \n",
      "4      -153.899994             11.0      0.169998  \n",
      "5       -33.540001             11.0      1.950001  \n",
      "[debug] Current totals → Portfolio: 101801.49, Net Invested: 102036.20\n",
      "[debug] Previous totals → Portfolio: 101801.49, Net Invested: 102036.20\n",
      "[debug] Saved new state → Portfolio: 101801.49, Net Invested: 102036.20\n",
      "[pptx prep] PortfolioValue series computed for 22 securities.\n",
      "[ppt] Report saved to: C:\\Users\\Fionn Guina\\Portfolio_Optimiser\\Portfolio_Report.pptx\n",
      ...
      "dtype: float64\n",
      "\n",
      "Min mu: 0.11757339351262133\n",
      "Max mu: 0.5370641094110555\n",
      "Mean mu: 0.228118553469389\n",
   ...
   "source": [
    ...
    "\n",
    "                # ---- Store achieved tilts for the \"With Tilts\" portfolio (for PPT Slide 5) ----\n",
    "                try:\n",
    "                    if (B is not None) and (not B.empty) and (\"w_tilt\" in locals()) and (w_tilt is not None) and np.all(np.isfinite(w_tilt)):\n",
    "                        wv = pd.Series(np.asarray(w_tilt, dtype=float).reshape(-1), index=Sigma_opt.index).fillna(0.0)\n",
    "                        wv = wv.reindex(B.index).fillna(0.0)\n",
    "                        if float(wv.sum()) != 0:\n",
    "                            wv = wv / float(wv.sum())\n",
    "                \n",
    "                        achieved = (B.T @ wv).rename(\"Achieved β\")\n",
    "                \n",
    "                        factor_order = [\"Mkt-RF\", \"SMB\", \"HML\", \"RMW\", \"CMA\", \"MOM\"]\n",
    "                        achieved = achieved.reindex([f for f in factor_order if f in achieved.index])\n",
    "                \n",
    "                        tilt_tbl = pd.DataFrame({\"Achieved β\": achieved})\n",
    "                \n",
    ...
    "                \n",
    "                        charts[\"with_tilts_achieved_tilts\"] = tilt_tbl.reset_index().rename(columns={\"index\": \"Factor\"}).to_dict(\"records\")\n",
    "                except Exception as _e_tilts_store:\n",
    "                    print(f\"[pptx] Could not store with-tilts achieved tilts: {_e_tilts_store}\")\n",
    "\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "                # chart on left\n",
    "                slide5.shapes.add_picture(eff_path, Inches(0.6), Inches(1.4), width=Inches(6.2), height=Inches(4.9))\n",
    "        \n",
    "                # points table on right\n",
    "                pts = {}\n",
    "                if isinstance(charts, dict):\n",
    "                    pts = charts.get(\"frontier_points\", {}) or {}\n",
    "        \n",
    "                rows = []\n",
    "                for k in [\"Current\", \"Previous\", \"With Tilts\", \"Target\"]:\n",
    "                    v = pts.get(k, None)\n",
    "                    if v is None:\n",
    "                        continue\n",
    "                    try:\n",
    ...
    "                # convert return to decimal for formatter; keep vol raw\n",
    "                df_show = df_pts.copy()\n",
    "                df_show[\"Return (ann.)\"] = df_show[\"Return (ann.)\"]\n",
    "                # Build a simple table: Point | Vol | Return\n",
    "                # (Using your existing table helper but with a “fake” percent column for return)\n",
    "                df_fmt = pd.DataFrame({\n",
    "                    \"Vol (ann.)\": df_show[\"Vol (ann.)\"],\n",
    "                    \"Return (ann.)\": df_show[\"Return (ann.)\"],\n",
    "                })\n",
    "                # Make a custom table (vol numeric, return %)\n",
    "                shp = slide5.shapes.add_table(df_fmt.shape[0] + 1, 3, Cm(16.75), Cm(4.2), Cm(8.26), Cm(4.74)) #Left,Top,Width,Height\n",
    "                tbl = shp.table\n",
    "                tbl.cell(0, 0).text = \"Point\"\n",
    "                tbl.cell(0, 1).text = \"Vol (ann.)\"\n",
    "                tbl.cell(0, 2).text = \"Return (ann.)\"\n",
    "    \n",
    "                for i, (idx, r) in enumerate(df_fmt.iterrows(), start=1):\n",
    "                    tbl.cell(i, 0).text = str(idx)\n",
    "                    tbl.cell(i, 1).text = f\"{float(r['Vol (ann.)']):.2%}\" if pd.notna(r[\"Vol (ann.)\"]) else \"\"\n",
    ...
    "                            p.alignment = PP_ALIGN.CENTER\n",
    "\n",
    "            # ---- Add \"With Tilts\" achieved tilts table underneath the points table ----\n",
    "            try:\n",
    "                tilt_rows = charts.get(\"with_tilts_achieved_tilts\", None) if isinstance(charts, dict) else None\n",
    "                if tilt_rows:\n",
    "                    df_tilts = pd.DataFrame(tilt_rows)\n",
    "            \n",
    "                    # Layout: directly under the first table\n",
    "                    left2 = Cm(16.75)     # align with the first table\n",
    "                    top2  = Cm(10.05)     # under the first table (tweak if needed)\n",
    "                    width2 = Cm(8.26)    # same width as first table\n",
    "                    height2 = Cm(4.74)\n",
    "            \n",
    ...
    "                print(f\"[pptx] Slide 5 tilts table skipped: {_e_tilts_tbl}\")\n",
    "            \n",
    "            else:\n",
    "                print(\"[pptx] Slide 5: efficient_frontier_path missing or file not found\")\n",
    "\n",
    "        except Exception as e:\n",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "[pptx] Slide 5: efficient_frontier_path missing or file not found\n",
      "[ppt] Report saved to: C:\\Users\\Fionn Guina\\Portfolio_Optimiser\\Portfolio_Report.pptx\n"
     ]
    }
   ],
