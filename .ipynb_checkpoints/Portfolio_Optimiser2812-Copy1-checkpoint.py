 ...
 "cells": [
  {
   ...
   "metadata": {},
   "source": [
    "# Grabbing Data From Yahoo Finance For Stock Build last updated 28/12/2025"
   ]
  },
  {
   "cell_type": "markdown",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Using FX-adjusted returns for Sigma?: True (max |diff|=4.34e-19)\n",
      "[frontier] target_returns from 3.6000% to 38.7123%\n",
      "[frontier] tangency ret ≈ 0.2393, vol ≈ 0.0384\n",
      "\n",
      "--- DEBUG CHECK: Sigma_opt / mu_vec_opt ---\n",
      "Any NaN in Sigma_opt: False\n",
      "Any NaN in mu_vec_opt: False\n",
      "Min variance: 4.0233326464822074e-05\n",
      "Number of assets: 22\n",
      "Security       A200.AX        IEU.AX    IJP.AX        IOO.AX        IVV.AX  \\\n",
      "Security                                                                     \n",
      "A200.AX   5.719961e-05  5.175725e-07  0.000005  1.622320e-06  1.782137e-06   \n",
      "IEU.AX    5.175725e-07  4.737992e-05  0.000003  6.451879e-07  5.609812e-07   \n",
      "IJP.AX    4.789286e-06  2.857005e-06  0.000148  5.352471e-06  5.351114e-06   \n",
      "IOO.AX    1.622320e-06  6.451879e-07  0.000005  8.639355e-05  2.434395e-06   \n",
      "IVV.AX    1.782137e-06  5.609812e-07  0.000005  2.434395e-06  8.175843e-05   \n",
      "\n",
      "Security       MTUM.AX        MVW.AX       QHAL.AX       QLTY.AX   QUAL.AX  \\\n",
      "Security                                                                     \n",
      "A200.AX   2.102280e-06  1.120518e-06  1.222490e-06  1.888811e-06  0.000003   \n",
      "IEU.AX    9.240448e-07  2.716708e-07  3.646976e-07  9.946415e-07  0.000001   \n",
      "IJP.AX    7.401279e-06  2.154862e-06  3.129522e-06  6.862418e-06  0.000010   \n",
      "IOO.AX    2.572132e-06  1.385008e-06  1.926614e-06  2.283924e-06  0.000004   \n",
      "IVV.AX    2.426891e-06  2.196178e-06  2.101462e-06  2.536084e-06  0.000004   \n",
      "\n",
      "Security  ...       SPY        VAS.AX       VDHG.AX        VGE.AX  \\\n",
      "Security  ...                                                       \n",
      "A200.AX   ...  0.000008  1.591736e-06  1.293128e-06  2.357079e-07   \n",
      "IEU.AX    ...  0.000005  5.979184e-07  4.850032e-07  4.737905e-07   \n",
      "IJP.AX    ...  0.000036  5.073689e-06  3.981963e-06  2.107605e-06   \n",
      "IOO.AX    ...  0.000006  1.658144e-06  1.602173e-06 -3.104600e-07   \n",
      "IVV.AX    ...  0.000003  1.825754e-06  1.811750e-06 -7.493753e-07   \n",
      "\n",
      "Security        VGS.AX       VLU   VLUE.AX       VMIN.AX        VSO.AX  \\\n",
      "Security                                                                 \n",
      "A200.AX   1.726135e-06  0.000010  0.000003  3.821492e-07  1.136110e-06   \n",
      "IEU.AX    7.590004e-07  0.000006  0.000002 -1.601160e-07  4.844380e-07   \n",
      "IJP.AX    5.800453e-06  0.000042  0.000011 -1.320953e-07  3.339976e-06   \n",
      "IOO.AX    2.252395e-06  0.000008  0.000004  5.201196e-07  1.040744e-06   \n",
      "IVV.AX    2.571242e-06  0.000006  0.000004  7.958730e-07  1.326969e-06   \n",
      "\n",
      "Security   VVLU.AX  \n",
      "Security            \n",
      "A200.AX   0.000003  \n",
      ...
      "max       0.662352\n",
      "dtype: float64\n",
      "Sigma diag min/max: 4.0233326464822074e-05 0.0006889468269601498\n",
      "Mkt-RF    0.258678\n",
      "SMB      -0.039122\n",
      "HML       0.020428\n",
      "RMW      -0.058772\n",
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "0  A200.AX        NaT          5         NaN          NaN     146.649994   \n",
      "1   IJP.AX        NaT         24         NaN          NaN     125.000000   \n",
      "2      SMH        NaT         28         NaN          NaN     545.603328   \n",
      "3      SPY        NaT         29         NaN          NaN    1029.452378   \n",
      "4      VLU 2025-12-26         30  317.167541  9515.026218     317.167541   \n",
      "5  VVLU.AX        NaT          2         NaN          NaN      80.620003   \n",
      "\n",
      "   Cash Flow (AUD)  Brokerage (AUD)  RealisedGain  \n",
      "0      -733.249969             11.0           NaN  \n",
      "1     -3000.000000             11.0           NaN  \n",
      "2    -15276.893178              0.0           NaN  \n",
      "3    -29854.118956              0.0           NaN  \n",
      "4     -9515.026218              0.0           0.0  \n",
      "5      -161.240005             11.0           NaN  \n",
      "[debug] Current totals → Portfolio: 102402.68, Net Invested: 102602.49\n",
      "[debug] Previous totals → Portfolio: 101274.95, Net Invested: 102038.62\n",
      "[debug] Saved new state → Portfolio: 102402.68, Net Invested: 102602.49\n",
      ...
      "dtype: float64\n",
      "\n",
      "Min mu: 0.1353086919119596\n",
      "Max mu: 0.6623519706747725\n",
      "Mean mu: 0.2541700729366982\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "        \n",
    "            slide_layout = prs.slide_layouts[20]  # title-only layout\n",
    "            slide = prs.slides.add_slide(slide_layout)\n",
    "        \n",
    "            # Set slide title\n",
    "            if slide.shapes.title:\n",
    ...
    "                    charts[\"efficient_frontier_path\"],\n",
    "                    Inches(0.7),\n",
    "                    Inches(1.4),\n",
    "                    width=Inches(8.6)\n",
    "                )\n",
