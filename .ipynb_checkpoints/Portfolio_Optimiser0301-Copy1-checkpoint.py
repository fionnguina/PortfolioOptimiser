 ...
 "cells": [
  {
   ...
   "metadata": {},
   "source": [
    "# Grabbing Data From Yahoo Finance For Stock Build last updated 03/1/2026"
   ]
  },
  {
   "cell_type": "markdown",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Using FX-adjusted returns for Sigma?: True (max |diff|=2.30e-19)\n",
      "[frontier] target_returns from 3.6000% to 35.5128%\n",
      "[frontier] tangency ret ≈ 0.2208, vol ≈ 0.0369\n",
      "\n",
      "--- DEBUG CHECK: Sigma_opt / mu_vec_opt ---\n",
      "Any NaN in Sigma_opt: False\n",
      "Any NaN in mu_vec_opt: False\n",
      "Min variance: 3.9768404529974584e-05\n",
      "Number of assets: 22\n",
      "Security       A200.AX        IEU.AX    IJP.AX        IOO.AX        IVV.AX  \\\n",
      "Security                                                                     \n",
      "A200.AX   5.771621e-05  2.620003e-07  0.000004  1.317338e-06  1.439086e-06   \n",
      "IEU.AX    2.620003e-07  4.718412e-05  0.000002  4.030692e-07  2.784497e-07   \n",
      "IJP.AX    3.819664e-06  1.877493e-06  0.000145  4.624892e-06  4.600309e-06   \n",
      "IOO.AX    1.317338e-06  4.030692e-07  0.000005  8.804148e-05  2.040602e-06   \n",
      "IVV.AX    1.439086e-06  2.784497e-07  0.000005  2.040602e-06  8.213754e-05   \n",
      "\n",
      "Security       MTUM.AX        MVW.AX       QHAL.AX       QLTY.AX  \\\n",
      "Security                                                           \n",
      "A200.AX   2.000148e-06  7.317899e-07  1.157864e-06  1.478391e-06   \n",
      "IEU.AX    6.984401e-07 -1.222904e-07  2.318943e-07  5.430288e-07   \n",
      "IJP.AX    7.269908e-06  5.026004e-07  2.513988e-06  5.831394e-06   \n",
      "IOO.AX    2.290702e-06  9.381008e-07  1.718249e-06  1.932052e-06   \n",
      "IVV.AX    2.125543e-06  1.662002e-06  1.838775e-06  2.144578e-06   \n",
      "\n",
      "Security       QUAL.AX  ...       SPY        VAS.AX       VDHG.AX  \\\n",
      "Security                ...                                         \n",
      "A200.AX   2.238448e-06  ...  0.000007  1.296482e-06  1.044435e-06   \n",
      "IEU.AX    8.791627e-07  ...  0.000004  2.931620e-07  2.304966e-07   \n",
      "IJP.AX    9.129941e-06  ...  0.000035  3.968107e-06  3.052068e-06   \n",
      "IOO.AX    3.105708e-06  ...  0.000005  1.325408e-06  1.290855e-06   \n",
      "IVV.AX    3.441321e-06  ...  0.000002  1.444196e-06  1.462174e-06   \n",
      "\n",
      "Security        VGE.AX        VGS.AX       VLU       VLUE.AX       VMIN.AX  \\\n",
      "Security                                                                     \n",
      "A200.AX   2.467355e-08  1.343951e-06  0.000008  2.003542e-06  4.542672e-07   \n",
      "IEU.AX    3.105058e-07  4.063037e-07  0.000005  9.848605e-07 -1.111235e-07   \n",
      "IJP.AX    1.288406e-06  4.929809e-06  0.000040  9.283097e-06 -6.347057e-08   \n",
      "IOO.AX   -4.237227e-07  1.861241e-06  0.000006  2.888039e-06  5.171925e-07   \n",
      "IVV.AX   -8.727149e-07  2.141529e-06  0.000004  3.165221e-06  7.893530e-07   \n",
      "\n",
      "Security        VSO.AX       VVLU.AX  \n",
      "Security                              \n",
      "A200.AX   5.879908e-07  2.480621e-06  \n",
      "IEU.AX    1.555538e-08  9.544423e-07  \n",
      "IJP.AX    5.678742e-07  1.021662e-05  \n",
      "IOO.AX    3.979726e-07  3.191279e-06  \n",
      "IVV.AX    5.537961e-07  3.645373e-06  \n",
      "\n",
      "[5 rows x 22 columns]\n",
      "Security\n",
      "A200.AX    0.132275\n",
      ...
      "max       0.546091\n",
      "dtype: float64\n",
      "Sigma diag min/max: 3.9768404529974584e-05 0.0006834517399292163\n",
      "Mkt-RF    0.188673\n",
      "SMB      -0.050877\n",
      "HML       0.013623\n",
      "RMW      -0.053427\n",
  ...
  },
  {
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "[debug] tilt_point=(0.14991758018210705, 0.28409651184612617), factor_point=None\n",
      "1 name: Chart 1 | title: Efficient Frontier\n",
      "\n",
      "=== LOT-EXPANDED TABLE ===\n",
      "  Security    AcqDate  UnitsSold   AcqPrice   CostBase  Last Px (AUD)  \\\n",
      "0  SMLL.AX 2025-12-15          4   4.590000  18.360001       4.680000   \n",
      "1  VDHG.AX 2025-12-15          1  73.790001  73.790001      74.000000   \n",
      "2  VLUE.AX 2025-11-21          1  31.590000  31.590000      33.500000   \n",
      "3   VSO.AX 2025-11-21          1  74.309998  74.309998      77.209999   \n",
      "\n",
      "   Cash Flow (AUD)  Brokerage (AUD)  RealisedGain  \n",
      "0       -18.719999             11.0      0.359999  \n",
      "1       -74.000000             11.0      0.209999  \n",
      "2       -33.500000             11.0      1.910000  \n",
      "3       -77.209999             11.0      2.900002  \n",
      "[debug] Current totals → Portfolio: 100865.37, Net Invested: 101068.80\n",
      "[debug] Previous totals → Portfolio: 100912.96, Net Invested: 101272.23\n",
      "[debug] Saved new state → Portfolio: 100865.37, Net Invested: 101068.80\n",
      ...
      "dtype: float64\n",
      "\n",
      "Min mu: 0.11757329034756389\n",
      "Max mu: 0.5460909542321888\n",
      "Mean mu: 0.2289049618784671\n",
   ...
   "source": [
    ...
    "                    )\n",
    "            \n",
    "                # ---------- Without Tilts (Target/Baseline) ----------\n",
    "                w_without = _norm_w(w_star.values if hasattr(w_star, \"values\") else w_star, Sigma_opt.index)\n",
    "                w_without = w_without.reindex(B.index).fillna(0.0)\n",
    "                if float(w_without.sum()) != 0:\n",
    "                    w_without = w_without / float(w_without.sum())\n",
    "            \n",
    "                without_beta = (B.T @ w_without).rename(\"Without Tilts\")\n",
    "                without_beta = without_beta.reindex([f for f in factor_order if f in without_beta.index])\n",
    "            \n",
    "                # ---------- Combined comparison table ----------\n",
    "                out = pd.DataFrame({\"Without Tilts\": without_beta})\n",
    "            \n",
    "                # Add With Tilts to comparison if available\n",
    "                if (\"w_tilt\" in locals()) and (w_tilt is not None) and np.all(np.isfinite(w_tilt)):\n",
    "                    out[\"With Tilts\"] = with_beta\n",
    "                    # Keep column order nice\n",
    "                    out = out[[\"With Tilts\", \"Without Tilts\"]]\n",
    "            \n",
  ...
  },
  {
   ...
   "source": [
    ...
    "    ppt_path = os.path.join(APP_DIR, f\"Portfolio_Report_{stamp}.pptx\")\n",
    "\n",
    ...
    "                        left2 = Cm(16.50)\n",
    "                        top2 = Cm(10.05)\n",
    "                        width2 = Cm(7.48)     # wider to fit multiple columns\n",
    "                        height2 = Cm(3.6)\n",
    "                \n",
