 ...
 "cells": [
  {
   ...
   "metadata": {},
   "source": [
    "### Grabbing Data From Yahoo Finance For Stock Build last updated 22/11/2025"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    ...
    "ff5_win_for_betas = ff5_raw.tail(504)     # 2 years of daily factor data\n",
    "\n",
    ...
    ")\n",
    "\n",
    "# 2) Currency excess return\n",
    "_fx_series = fx.reindex(ff5_raw.index).ffill()\n",
    "_fx_ret = _fx_series.pct_change().fillna(0.0)\n",
    "\n",
    "# 3) Build AUD-adjusted factor set\n",
    "def get_ff5_mom_aud():\n",
    "    ff = ff5_raw.copy()\n",
    "    for col in ff.columns:\n",
    "        if col != \"RF\":  # RF stays untouched\n",
    "            ff[col] = ff[col] + _fx_ret\n",
    "    return ff\n",
    "\n",
    ...
    "    Sigma_ff_daily = (B @ ff5_win[fac_cols].cov() @ B.T) + np.diag(resid_var.reindex(B.index).clip(lower=0).fillna(0))\n",
