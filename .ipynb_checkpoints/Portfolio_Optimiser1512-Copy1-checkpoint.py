 ...
 "cells": [
  {
   ...
   "metadata": {},
   "source": [
    "# Grabbing Data From Yahoo Finance For Stock Build last updated 15/12/2025"
   ]
  },
  {
   "cell_type": "markdown",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Using FX-adjusted returns for Sigma?: True (max |diff|=6.51e-19)\n",
      "[frontier] target_returns from 3.6000% to 37.8388%\n",
      "[frontier] tangency ret ≈ 0.2342, vol ≈ 0.0383\n",
      "\n",
      "--- DEBUG CHECK: Sigma_opt / mu_vec_opt ---\n",
      "Any NaN in Sigma_opt: False\n",
      "Any NaN in mu_vec_opt: False\n",
      "Min variance: 4.019388294569233e-05\n",
      "Number of assets: 22\n",
      "Security       A200.AX        IEU.AX    IJP.AX        IOO.AX        IVV.AX  \\\n",
      "Security                                                                     \n",
      "A200.AX   5.662289e-05  4.755416e-07  0.000005  1.672536e-06  1.822612e-06   \n",
      "IEU.AX    4.755416e-07  4.665941e-05  0.000002  5.486098e-07  4.506092e-07   \n",
      "IJP.AX    4.809064e-06  2.452430e-06  0.000145  5.180239e-06  5.091192e-06   \n",
      "IOO.AX    1.672536e-06  5.486098e-07  0.000005  8.494576e-05  2.391227e-06   \n",
      "IVV.AX    1.822612e-06  4.506092e-07  0.000005  2.391227e-06  8.041150e-05   \n",
      "\n",
      "Security       MTUM.AX        MVW.AX       QHAL.AX       QLTY.AX   QUAL.AX  \\\n",
      "Security                                                                     \n",
      "A200.AX   2.128491e-06  1.197604e-06  1.273245e-06  1.915413e-06  0.000003   \n",
      "IEU.AX    7.866085e-07  2.479411e-07  3.158941e-07  8.460907e-07  0.000001   \n",
      "IJP.AX    7.104162e-06  2.134744e-06  3.095864e-06  6.464461e-06  0.000010   \n",
      "IOO.AX    2.536971e-06  1.398840e-06  1.940678e-06  2.225594e-06  0.000004   \n",
      "IVV.AX    2.358224e-06  2.204777e-06  2.114491e-06  2.446674e-06  0.000004   \n",
      "\n",
      "Security  ...       SPY        VAS.AX       VDHG.AX        VGE.AX  \\\n",
      "Security  ...                                                       \n",
      "A200.AX   ...  0.000008  1.666974e-06  1.334896e-06  1.339984e-07   \n",
      "IEU.AX    ...  0.000004  5.504552e-07  4.218411e-07  3.985598e-07   \n",
      "IJP.AX    ...  0.000034  5.080554e-06  3.872422e-06  1.743855e-06   \n",
      "IOO.AX    ...  0.000006  1.707959e-06  1.603703e-06 -3.616531e-07   \n",
      "IVV.AX    ...  0.000002  1.864495e-06  1.802749e-06 -7.988696e-07   \n",
      "\n",
      "Security        VGS.AX       VLU   VLUE.AX       VMIN.AX        VSO.AX  \\\n",
      "Security                                                                 \n",
      "A200.AX   1.758425e-06  0.000010  0.000003  3.411522e-07  1.196057e-06   \n",
      "IEU.AX    6.364619e-07  0.000006  0.000002 -1.903957e-07  4.635977e-07   \n",
      "IJP.AX    5.484710e-06  0.000040  0.000010 -3.722130e-07  3.388941e-06   \n",
      "IOO.AX    2.200067e-06  0.000008  0.000003  4.125421e-07  1.109410e-06   \n",
      "IVV.AX    2.493399e-06  0.000005  0.000004  6.948368e-07  1.392004e-06   \n",
      "\n",
      "Security   VVLU.AX  \n",
      "Security            \n",
      "A200.AX   0.000003  \n",
      ...
      "max       0.658290\n",
      "dtype: float64\n",
      "Sigma diag min/max: 4.019388294569233e-05 0.0006890099478648007\n",
      "Mkt-RF    0.258678\n",
      "SMB      -0.039122\n",
      "HML       0.020428\n",
      "RMW      -0.058772\n",
  ...
  },
  {
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "0  A200.AX     NaT          3       NaN       NaN     144.759995   \n",
      "1   IJP.AX     NaT         26       NaN       NaN     126.830002   \n",
      "2  MTUM.AX     NaT          6       NaN       NaN      28.719999   \n",
      "3      SMH     NaT         28       NaN       NaN     532.561079   \n",
      "4      SPY     NaT         29       NaN       NaN    1025.298914   \n",
      "5      VLU     NaT         30       NaN       NaN     319.314082   \n",
      "6  VVLU.AX     NaT          3       NaN       NaN      81.800003   \n",
      "\n",
      "   Cash Flow (AUD)  Brokerage (AUD)  RealisedGain  \n",
      "0      -434.279984              0.0           NaN  \n",
      "1     -3297.580048              0.0           NaN  \n",
      "2      -172.319996              0.0           NaN  \n",
      "3    -14911.710205              0.0           NaN  \n",
      "4    -29733.668493              0.0           NaN  \n",
      "5     -9579.422465              0.0           NaN  \n",
      "6      -245.400009              0.0           NaN  \n",
      "[cgt] audit_df is empty (no CGT-relevant sells).\n",
      "[debug] Current totals → Portfolio: 101511.06, Net Invested: 101847.92\n",
      "[debug] Previous totals → Portfolio: 101511.06, Net Invested: 101847.92\n",
      "[debug] Saved new state → Portfolio: 101511.06, Net Invested: 101847.92\n",
      ...
      "dtype: float64\n",
      "\n",
      "Min mu: 0.1394750445485224\n",
      "Max mu: 0.6582902633292274\n",
      "Mean mu: 0.24775300857794427\n",
   ...
   "source": [
    ...
    "    sht.autofit()\n",
    "\n",
    "def update_efficient_frontier_chart(opt_sheet, stats_df, start_s_row, rf_annual, tan_ret, tan_vol, current_point, title_text, target_point=None):\n",
