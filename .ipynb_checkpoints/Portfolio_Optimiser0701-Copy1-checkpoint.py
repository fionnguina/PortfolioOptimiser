 ...
 "cells": [
  {
   ...
   "metadata": {},
   "source": [
    "# Grabbing Data From Yahoo Finance For Stock Build last updated 07/01/2026"
   ]
  },
  {
   "cell_type": "markdown",
  ...
  },
  {
   ...
   "source": [
    ...
    "    cash_buffer: float = 0.00,         # fraction of portfolio to keep as cash (e.g. 0.01 = 1%)\n",
    "    min_trade_aud: float = 0.0,        # ignore tiny trades (e.g. 200)\n",
    "    round_to_whole_units: bool = True  # ETFs/stocks generally whole units\n",
    ") -> pd.DataFrame:\n",
    "    \"\"\"\n",
    ...
    "    tp_no_tilts  = build_trade_plan_from_units(units_series, last_px, w_no_tilts,  cash_buffer=0.00, min_trade_aud=200)\n",
    "    tp_with_tilts= build_trade_plan_from_units(units_series, last_px, w_with_tilts, cash_buffer=0.00, min_trade_aud=200)\n",
    "    \n",
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "#-------Add triggers for opening applications ----------\n",
    "\n",
    "open_excel_var = _tk.BooleanVar(value=bool(globals().get(\"OPEN_EXCEL_AFTER_SAVE\", True)))\n",
    "open_ppt_var   = _tk.BooleanVar(value=bool(globals().get(\"OPEN_PPT_AFTER_SAVE\", True)))\n",
    "\n",
    "_ttk.Checkbutton(root, text=\"Open Excel after Save\", variable=open_excel_var).pack(anchor=\"w\", padx=8)\n",
    "_ttk.Checkbutton(root, text=\"Open PowerPoint after Save\", variable=open_ppt_var).pack(anchor=\"w\", padx=8)\n",
    "\n",
    "\n",
    "#-------Add Portfolio Value Functionality-----------\n",
    "\n",
    "portfolio_value_var = _tk.StringVar(value=\"\")\n",
    "use_portfolio_value = _tk.BooleanVar(value=False)\n",
    "\n",
    "_ttk.Checkbutton(root, text=\"Build from Portfolio Value (AUD) instead of units\",\n",
    "                 variable=use_portfolio_value).pack(anchor=\"w\", padx=8, pady=4)\n",
    "\n",
    "frm_val = _ttk.Frame(root)\n",
    "frm_val.pack(fill=\"x\", padx=8)\n",
    ...
    "                try:\n",
    "                    portfolio_value_override = float(portfolio_value_var.get())\n",
    "                except ValueError:\n",
    "                    portfolio_value_override = None\n",
    "            \n",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Using FX-adjusted returns for Sigma?: True (max |diff|=3.25e-19)\n",
      "[frontier] target_returns from 3.6000% to 36.5875%\n",
      "[frontier] tangency ret ≈ 0.2270, vol ≈ 0.0370\n",
      "\n",
      "--- DEBUG CHECK: Sigma_opt / mu_vec_opt ---\n",
      "Any NaN in Sigma_opt: False\n",
      "Any NaN in mu_vec_opt: False\n",
      "Min variance: 4.005811128465787e-05\n",
      "Number of assets: 22\n",
      "Security       A200.AX        IEU.AX    IJP.AX        IOO.AX        IVV.AX  \\\n",
      "Security                                                                     \n",
      "A200.AX   5.752828e-05  1.511176e-07  0.000003  1.173503e-06  1.298958e-06   \n",
      "IEU.AX    1.511176e-07  4.720710e-05  0.000002  3.528087e-07  2.417412e-07   \n",
      "IJP.AX    3.255880e-06  1.837970e-06  0.000147  4.550905e-06  4.630346e-06   \n",
      "IOO.AX    1.173503e-06  3.528087e-07  0.000005  8.865004e-05  1.993993e-06   \n",
      "IVV.AX    1.298958e-06  2.417412e-07  0.000005  1.993993e-06  8.275535e-05   \n",
      "\n",
      "Security       MTUM.AX        MVW.AX       QHAL.AX       QLTY.AX  \\\n",
      "Security                                                           \n",
      "A200.AX   1.804866e-06  6.276550e-07  1.060496e-06  1.260700e-06   \n",
      "IEU.AX    6.541161e-07 -2.358841e-07  1.544061e-07  4.691542e-07   \n",
      "IJP.AX    7.392526e-06 -2.208640e-07  2.131300e-06  5.695919e-06   \n",
      "IOO.AX    2.241859e-06  7.803051e-07  1.622825e-06  1.823092e-06   \n",
      "IVV.AX    2.096694e-06  1.510246e-06  1.742333e-06  2.065748e-06   \n",
      "\n",
      "Security       QUAL.AX  ...       SPY        VAS.AX       VDHG.AX  \\\n",
      "Security                ...                                         \n",
      "A200.AX   1.908264e-06  ...  0.000006  1.146886e-06  9.337721e-07   \n",
      "IEU.AX    8.141052e-07  ...  0.000004  1.816591e-07  1.625453e-07   \n",
      "IJP.AX    9.271786e-06  ...  0.000036  3.406368e-06  2.764846e-06   \n",
      "IOO.AX    3.003016e-06  ...  0.000005  1.175232e-06  1.201276e-06   \n",
      "IVV.AX    3.387738e-06  ...  0.000002  1.301217e-06  1.378998e-06   \n",
      "\n",
      "Security        VGE.AX        VGS.AX       VLU       VLUE.AX       VMIN.AX  \\\n",
      "Security                                                                     \n",
      "A200.AX  -4.073773e-08  1.174662e-06  0.000007  1.684470e-06  4.731130e-07   \n",
      "IEU.AX    2.906964e-07  3.686693e-07  0.000004  9.453897e-07 -1.084357e-07   \n",
      "IJP.AX    1.244861e-06  4.984913e-06  0.000042  9.714076e-06 -2.737470e-08   \n",
      "IOO.AX   -4.663920e-07  1.806048e-06  0.000006  2.842691e-06  5.260261e-07   \n",
      "IVV.AX   -9.123219e-07  2.109909e-06  0.000004  3.172855e-06  7.949739e-07   \n",
      "\n",
      "Security        VSO.AX       VVLU.AX  \n",
      "Security                              \n",
      "A200.AX   5.429095e-07  2.141861e-06  \n",
      "IEU.AX   -1.259152e-07  8.990048e-07  \n",
      "IJP.AX   -3.254246e-07  1.057959e-05  \n",
      "IOO.AX    2.393552e-07  3.114695e-06  \n",
      "IVV.AX    3.773444e-07  3.625498e-06  \n",
      "\n",
      "[5 rows x 22 columns]\n",
      "Security\n",
      "A200.AX    0.145478\n",
      ...
      "max       0.527738\n",
      "dtype: float64\n",
      "Sigma diag min/max: 4.005811128465787e-05 0.00068940917454991\n",
      "Mkt-RF    0.188673\n",
      "SMB      -0.050877\n",
      "HML       0.013623\n",
      "RMW      -0.053427\n",
  ...
  },
  {
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "[debug] tilt_point=(0.14761066848851306, 0.27592637912217827), factor_point=None\n",
      "1 name: Chart 1 | title: Efficient Frontier\n",
      "\n",
      "=== LOT-EXPANDED TABLE ===\n",
      "  Security    AcqDate  UnitsSold    AcqPrice     CostBase  Last Px (AUD)  \\\n",
      "0   IEU.AX 2025-12-15          4  101.480003   405.920013     102.889999   \n",
      "1   IJP.AX        NaT          2         NaN          NaN     123.230003   \n",
      "2  MTUM.AX 2025-12-30          4   29.080000   116.320000      28.545000   \n",
      "3  MTUM.AX 2025-12-30          4   29.070000   116.279999      28.545000   \n",
      "4  MTUM.AX        NaT         10         NaN          NaN      28.545000   \n",
      "5   VGE.AX 2025-12-15          3   89.910004   269.730011      90.889999   \n",
      "6  VLUE.AX 2025-11-21          9   31.590000   284.310001      34.099998   \n",
      "7  VLUE.AX 2025-12-15          4   33.450001   133.800003      34.099998   \n",
      "8  VMIN.AX 2025-12-15         18   63.180000  1137.240005      63.060001   \n",
      "9  VVLU.AX 2025-12-29          1   80.989998    80.989998      81.199997   \n",
      "\n",
      "   Cash Flow (AUD)  Brokerage (AUD)  RealisedGain  \n",
      "0      -411.559998             11.0      5.639984  \n",
      "1      -246.460007             11.0           NaN  \n",
      "2      -513.810001             11.0     -2.139999  \n",
      "3      -513.810001             11.0     -2.099998  \n",
      "4      -513.810001             11.0           NaN  \n",
      "5      -272.669998             11.0      2.939987  \n",
      "6      -443.299980             11.0     22.589985  \n",
      "7      -443.299980             11.0      2.599991  \n",
      "8     -1135.080025             11.0     -2.159981  \n",
      "9       -81.199997             11.0      0.209999  \n",
      "[debug] Current totals → Portfolio: 102474.26, Net Invested: 102273.96\n",
      "[debug] Previous totals → Portfolio: 100865.37, Net Invested: 101068.80\n",
      "[debug] Saved new state → Portfolio: 102474.26, Net Invested: 102273.96\n",
      ...
      "dtype: float64\n",
      "\n",
      "Min mu: 0.12380680311790279\n",
      "Max mu: 0.5277380152336445\n",
      "Mean mu: 0.23139187911159687\n",
   ...
   "source": [
    ...
    "                w_star_with_tilts = pd.Series(w_tilt, index=Sigma_opt.index).fillna(0.0)\n",
    "                if float(w_star_with_tilts.sum()) != 0:\n",
    "                    w_star_with_tilts = w_star_with_tilts / float(w_star_with_tilts.sum())\n",
    "            else:\n",
    "                # fallback: if tilt solve failed, default to no-tilts\n",
    ...
    "\n",
    "            \n",
    "            # ---- Achieved factor tilts table (prefer tilt-adjusted portfolio if available) ----\n",
    "            tilts_out = None\n",
    "            if (B is not None) and (not B.empty):\n",
    "                factor_order = [\"Mkt-RF\",\"SMB\",\"HML\",\"RMW\",\"CMA\",\"MOM\"]\n",
    "            \n",
    "                # Prefer tilt-adjusted weights if they exist\n",
    "                if \"w_tilt\" in locals() and w_tilt is not None and np.all(np.isfinite(w_tilt)):\n",
    "                    w_use = pd.Series(w_tilt, index=Sigma_opt.index)\n",
    "                else:\n",
    "                    w_use = w_star.copy()\n",
    "            \n",
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "if OPEN_AFTER_SAVE and ppt_path and os.path.exists(ppt_path):\n",
