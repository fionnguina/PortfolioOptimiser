 ...
 "cells": [
  {
   ...
   "metadata": {},
   "source": [
    "# Grabbing Data From Yahoo Finance For Stock Build last updated 29/12/2025"
   ]
  },
  {
   "cell_type": "markdown",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Using FX-adjusted returns for Sigma?: True (max |diff|=5.42e-19)\n",
      "[frontier] target_returns from 3.6000% to 35.7144%\n",
      "[frontier] tangency ret ≈ 0.2219, vol ≈ 0.0369\n",
      "\n",
      "--- DEBUG CHECK: Sigma_opt / mu_vec_opt ---\n",
      "Any NaN in Sigma_opt: False\n",
      "Any NaN in mu_vec_opt: False\n",
      "Min variance: 3.952303977497496e-05\n",
      "Number of assets: 22\n",
      "Security       A200.AX        IEU.AX    IJP.AX        IOO.AX        IVV.AX  \\\n",
      "Security                                                                     \n",
      "A200.AX   5.739519e-05  2.559230e-07  0.000004  1.284031e-06  1.407746e-06   \n",
      "IEU.AX    2.559230e-07  4.691570e-05  0.000002  3.955765e-07  2.700467e-07   \n",
      "IJP.AX    3.745110e-06  1.867352e-06  0.000144  4.594097e-06  4.575555e-06   \n",
      "IOO.AX    1.284031e-06  3.955765e-07  0.000005  8.750440e-05  2.031005e-06   \n",
      "IVV.AX    1.407746e-06  2.700467e-07  0.000005  2.031005e-06  8.164040e-05   \n",
      "\n",
      "Security       MTUM.AX        MVW.AX       QHAL.AX       QLTY.AX  \\\n",
      "Security                                                           \n",
      "A200.AX   1.948566e-06  6.994586e-07  1.129808e-06  1.449242e-06   \n",
      "IEU.AX    6.831467e-07 -1.241125e-07  2.194989e-07  5.382690e-07   \n",
      "IJP.AX    7.199202e-06  4.384276e-07  2.484689e-06  5.798561e-06   \n",
      "IOO.AX    2.266449e-06  9.102492e-07  1.706957e-06  1.921185e-06   \n",
      "IVV.AX    2.108233e-06  1.633272e-06  1.834071e-06  2.137119e-06   \n",
      "\n",
      "Security       QUAL.AX  ...       SPY        VAS.AX       VDHG.AX  \\\n",
      "Security                ...                                         \n",
      "A200.AX   2.193305e-06  ...  0.000007  1.250808e-06  1.018507e-06   \n",
      "IEU.AX    8.679412e-07  ...  0.000004  2.873464e-07  2.246903e-07   \n",
      "IJP.AX    9.076865e-06  ...  0.000035  3.891512e-06  3.021301e-06   \n",
      "IOO.AX    3.092474e-06  ...  0.000005  1.291644e-06  1.278089e-06   \n",
      "IVV.AX    3.434598e-06  ...  0.000002  1.412232e-06  1.452584e-06   \n",
      "\n",
      "Security        VGE.AX        VGS.AX       VLU       VLUE.AX       VMIN.AX  \\\n",
      "Security                                                                     \n",
      "A200.AX   2.977859e-08  1.317950e-06  0.000008  1.979468e-06  4.351152e-07   \n",
      "IEU.AX    3.193786e-07  3.999842e-07  0.000005  9.832130e-07 -1.161567e-07   \n",
      "IJP.AX    1.302272e-06  4.910205e-06  0.000040  9.258772e-06 -8.884102e-08   \n",
      "IOO.AX   -4.229836e-07  1.855394e-06  0.000006  2.884104e-06  5.057368e-07   \n",
      "IVV.AX   -8.747002e-07  2.140239e-06  0.000004  3.164637e-06  7.797149e-07   \n",
      "\n",
      "Security        VSO.AX       VVLU.AX  \n",
      "Security                              \n",
      "A200.AX   5.840783e-07  2.445406e-06  \n",
      "IEU.AX    2.003287e-08  9.489053e-07  \n",
      "IJP.AX    5.667687e-07  1.017890e-05  \n",
      "IOO.AX    3.920776e-07  3.185146e-06  \n",
      "IVV.AX    5.465466e-07  3.643363e-06  \n",
      "\n",
      "[5 rows x 22 columns]\n",
      "Security\n",
      "A200.AX    0.135564\n",
      ...
      "max       0.528538\n",
      "dtype: float64\n",
      "Sigma diag min/max: 3.952303977497496e-05 0.0006882433898313263\n",
      "Mkt-RF    0.188673\n",
      "SMB      -0.050877\n",
      "HML       0.013623\n",
      "RMW      -0.053427\n",
  ...
  },
  {
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "1 name: Chart 2 | title: Efficient Frontier & CAL (rf=3.60%)\n",
      "\n",
      "=== LOT-EXPANDED TABLE ===\n",
      "  Security    AcqDate  UnitsSold    AcqPrice     CostBase  Last Px (AUD)  \\\n",
      "0  A200.AX        NaT          9         NaN          NaN     146.490005   \n",
      "1   IJP.AX        NaT         23         NaN          NaN     120.410004   \n",
      "2  MTUM.AX        NaT          9         NaN          NaN      29.150000   \n",
      "3      SMH        NaT         29         NaN          NaN     544.326487   \n",
      "4      SPY        NaT         29         NaN          NaN    1027.043216   \n",
      "5   VAS.AX 2025-12-26          1  109.379997   109.379997     109.169998   \n",
      "6   VAS.AX 2025-12-26          1  109.379997   109.379997     109.169998   \n",
      "7   VAS.AX        NaT          1         NaN          NaN     109.169998   \n",
      "8      VLU 2025-12-26         30  317.167541  9515.026218     316.425294   \n",
      "\n",
      "   Cash Flow (AUD)  Brokerage (AUD)  RealisedGain  \n",
      "0     -1318.410049             11.0           NaN  \n",
      "1     -2769.430084             11.0           NaN  \n",
      "2      -262.349997             11.0           NaN  \n",
      "3    -15785.468122              0.0           NaN  \n",
      "4    -29784.253259              0.0           NaN  \n",
      "5      -327.509995             11.0     -0.209999  \n",
      "6      -327.509995             11.0     -0.209999  \n",
      "7      -327.509995             11.0           NaN  \n",
      "8     -9492.758806              0.0    -22.267411  \n",
      "[debug] Current totals → Portfolio: 102353.07, Net Invested: 102450.59\n",
      "[debug] Previous totals → Portfolio: 102402.68, Net Invested: 102602.49\n",
      "[debug] Saved new state → Portfolio: 102353.07, Net Invested: 102450.59\n",
      ...
      "dtype: float64\n",
      "\n",
      "Min mu: 0.12083619424036322\n",
      "Max mu: 0.5285375198555633\n",
      "Mean mu: 0.2287889499903155\n",
   ...
   "source": [
    ...
    "                prices[\"PortfolioValue\"] = portfolio_value_series\n",
    "\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "                if isinstance(pxdf, pd.DataFrame) and \"PortfolioValue\" in pxdf.columns:\n",
    "                    port_px = pxdf[\"PortfolioValue\"]\n",
    "            \n",
    ...
    "        \n",
    "                # Build quarterly “benchmark series”\n",
    "                ff_cols = [c for c in [\"Mkt-RF\",\"SMB\",\"HML\",\"RMW\",\"CMA\",\"MOM\",\"RF\"] if c in ff.columns]\n",
    "                ffq = ff[ff_cols].dropna().copy()\n",
    "        \n",
    "                # Convert to quarterly compounded returns\n",
    "                ffq = (1.0 + ffq).resample(\"Q\").prod() - 1.0\n",
    "        \n",
    "                # Market total return proxy = (Mkt-RF + RF)\n",
    "                if (\"Mkt-RF\" in ffq.columns) and (\"RF\" in ffq.columns):\n",
    "                    ffq[\"Market (Mkt-RF+RF)\"] = ffq[\"Mkt-RF\"] + ffq[\"RF\"]\n",
    "        \n",
    "                # Portfolio quarterly returns\n",
    "                port_q = port_px.resample(\"Q\").last().pct_change().dropna()\n",
    "                common_end = min(ffq.index.max(), port_q.index.max())\n",
    "                ffq = ffq.loc[:common_end]\n",
    "                port_q = port_q.loc[:common_end]\n",
    "        \n",
    "                # Choose a small set to chart (readable)\n",
    "                series_to_show = []\n",
    "                if \"Market (Mkt-RF+RF)\" in ffq.columns:\n",
    "                    series_to_show.append(\"Market (Mkt-RF+RF)\")\n",
    "                for c in [\"SMB\",\"HML\",\"RMW\",\"CMA\",\"MOM\"]:\n",
    "                    if c in ffq.columns:\n",
    "                        series_to_show.append(c)\n",
    "        \n",
    "                chart_df = pd.DataFrame({\"Portfolio\": port_q}).join(ffq[series_to_show], how=\"inner\")\n",
    "        \n",
    "                # Chart (cumulative growth from 1.0)\n",
    "                APP_DIR = os.path.dirname(os.path.abspath(__file__)) if \"__file__\" in globals() else os.getcwd()\n",
    "                ff_chart_path = os.path.join(APP_DIR, \"ff_benchmarks.png\")\n",
    "        \n",
    "                cum = (1.0 + chart_df.fillna(0.0)).cumprod()\n",
    "                fig, ax = plt.subplots(figsize=(7.5, 4.8))\n",
    "                cum.plot(ax=ax, linewidth=1.6)\n",
    "                ax.set_title(\"Quarterly Growth of $1 (FF factors are not directly investable)\")\n",
    "                ax.set_ylabel(\"Growth\")\n",
    "                ax.grid(True, linestyle=\"--\", alpha=0.4)\n",
    "                fig.savefig(ff_chart_path, bbox_inches=\"tight\")\n",
    "                plt.close(fig)\n",
    "        \n",
    "                slide4.shapes.add_picture(ff_chart_path, Inches(0.8), Inches(1.3), width=Inches(8.2), height=Inches(4.4))\n",
    "        \n",
    "                # Table: 3m/6m/12m/3y using quarters (1Q/2Q/4Q/12Q)\n",
    "                # (Quarterly “3Y” = 12 quarters)\n",
    "                def _qtr_window_total(r: pd.Series, n_q: int):\n",
    "                    r = pd.to_numeric(r, errors=\"coerce\").dropna()\n",
    "                    if len(r) < n_q:\n",
    "                        return np.nan\n",
    "                    return float((1.0 + r.tail(n_q)).prod() - 1.0)\n",
    "        \n",
    "                rows = {}\n",
    "                for name in chart_df.columns:\n",
    "                    rr = chart_df[name]\n",
    "                    rows[name] = [\n",
    "                        _qtr_window_total(rr, 1),\n",
    "                        _qtr_window_total(rr, 2),\n",
    "                        _qtr_window_total(rr, 4),\n",
    "                        _qtr_window_total(rr, 12),\n",
    "                    ]\n",
    "        \n",
    ...
    "                    width=Inches(8.2),\n",
    "                    height=Inches(1.0),\n",
    "                    title=\"Return Summary (Quarterly)\"\n",
    "                )\n",
    "        except Exception as e:\n",
    ...
    "        \n",
    "                rows = []\n",
    "                for k in [\"Current\", \"Previous\", \"Factor-effected\", \"Target\"]:\n",
    "                    v = pts.get(k, None)\n",
    "                    if v is None:\n",
    "                        continue\n",
    "                    try:\n",
    ...
    "                    shp = slide5.shapes.add_table(df_fmt.shape[0] + 1, 3, Inches(7.0), Inches(1.6), Inches(2.8), Inches(2.6))\n",
    "                    tbl = shp.table\n",
    ...
    "                                    p.font.bold = True\n",
    "            else:\n",
    "                print(\"[pptx] Slide 5: efficient_frontier_path missing\")\n",
    "        except Exception as e:\n",
    "            print(f\"[pptx] Slide 5 skipped: {e}\")\n",
    "\n",
    "        \n",
    "        prs.save(ppt_path)\n",
    "        open_ppt_if_enabled(str(ppt_path))\n",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "[pptx] Slide 5: efficient_frontier_path missing\n",
      "[ppt] Report saved to: C:\\Users\\Fionn Guina\\Portfolio_Optimiser\\Portfolio_Report.pptx\n"
     ]
    }
   ],
