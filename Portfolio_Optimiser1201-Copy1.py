 ...
 "cells": [
  {
   ...
   "metadata": {},
   "source": [
    "# Grabbing Data From Yahoo Finance For Stock Build last updated 12/01/2026"
   ]
  },
  {
   "cell_type": "markdown",
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "def kill_orphan_powerpoint() -> None:\n",
    "    # Windows-only: safe no-op on other OS if taskkill not available\n",
    "    try:\n",
    "        import subprocess\n",
    "        subprocess.run(\n",
    ...
    "\n",
    "    # Safety check: if weights are unlabelled (0..n-1), trade plan will zero everything\n",
    "    if len(target_weights.index) and isinstance(target_weights.index[0], (int, np.integer)):\n",
    "        raise ValueError(\"target_weights must be a ticker-indexed Series (e.g., index=prices columns).\")\n",
    "\n",
    "    \n",
  ...
  },
  {
   ...
   "source": [
    ...
    "            # In Jupyter, Tkinter messageboxes can freeze the kernel.\n",
    "            # Use a deterministic, safe selection instead.\n",
    "            if \"ipykernel\" in sys.modules:\n",
    "                # Jupyter fallback (change default here if desired)\n",
    ...
    "                _root.withdraw()\n",
    "                _root.update()\n",
    "                use_with_tilts_for_tradeplan = _messagebox.askyesno(\n",
    "                    \"Trade Plan Portfolio\",\n",
    "                    \"Use the WITH TILTS portfolio for the Trade Plan?\\n\\nYes = With Tilts\\nNo = Optimised (No Tilts)\"\n",
    "                )\n",
    "                _root.destroy()\n",
    "                globals()[\"TRADE_PLAN_MODE\"] = \"with_tilts\" if use_with_tilts_for_tradeplan else \"no_tilts\"\n",
    "\n",
    "\n",
    "            \n",
  ...
  },
  {
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Using FX-adjusted returns for Sigma?: True (max |diff|=2.44e-19)\n",
      "[frontier] target_returns from 3.6000% to 35.6179%\n",
      "[frontier] tangency ret ≈ 0.2214, vol ≈ 0.0372\n",
      "\n",
      "--- DEBUG CHECK: Sigma_opt / mu_vec_opt ---\n",
      "Any NaN in Sigma_opt: False\n",
      "Any NaN in mu_vec_opt: False\n",
      "Min variance: 4.01309681736623e-05\n",
      "Number of assets: 21\n",
      "Security       A200.AX        IEU.AX    IJP.AX        IOO.AX        IVV.AX  \\\n",
      "Security                                                                     \n",
      "A200.AX   5.744877e-05  2.229567e-07  0.000004  1.261151e-06  1.383328e-06   \n",
      "IEU.AX    2.229567e-07  4.703126e-05  0.000002  4.303169e-07  3.149155e-07   \n",
      "IJP.AX    3.518586e-06  2.047139e-06  0.000146  4.611636e-06  4.691310e-06   \n",
      "IOO.AX    1.261151e-06  4.303169e-07  0.000005  8.867288e-05  2.032114e-06   \n",
      "IVV.AX    1.383328e-06  3.149155e-07  0.000005  2.032114e-06  8.289928e-05   \n",
      "\n",
      "Security       MTUM.AX        MVW.AX       QHAL.AX       QLTY.AX  \\\n",
      "Security                                                           \n",
      "A200.AX   1.910988e-06  6.672026e-07  1.113846e-06  1.367979e-06   \n",
      "IEU.AX    7.399223e-07 -1.996136e-07  2.075892e-07  5.624009e-07   \n",
      "IJP.AX    7.315559e-06  8.395783e-08  2.214988e-06  5.775572e-06   \n",
      "IOO.AX    2.287977e-06  8.585046e-07  1.635581e-06  1.877291e-06   \n",
      "IVV.AX    2.143053e-06  1.583161e-06  1.762653e-06  2.123169e-06   \n",
      "\n",
      "Security       QUAL.AX  ...       SMLL.AX       SPY        VAS.AX  \\\n",
      "Security                ...                                         \n",
      "A200.AX   2.067181e-06  ...  2.402737e-07  0.000007  1.229291e-06   \n",
      "IEU.AX    9.467372e-07  ... -3.355172e-07  0.000004  2.553622e-07   \n",
      "IJP.AX    9.237736e-06  ... -3.004650e-06  0.000035  3.659215e-06   \n",
      "IOO.AX    3.064219e-06  ... -5.647893e-07  0.000005  1.262804e-06   \n",
      "IVV.AX    3.453175e-06  ... -7.178884e-07  0.000002  1.385604e-06   \n",
      "\n",
      "Security       VDHG.AX        VGE.AX        VGS.AX   VLUE.AX       VMIN.AX  \\\n",
      "Security                                                                     \n",
      "A200.AX   1.002150e-06 -8.959821e-09  1.269556e-06  0.000002  4.449338e-07   \n",
      "IEU.AX    2.243115e-07  3.154250e-07  4.493884e-07  0.000001 -1.307546e-07   \n",
      "IJP.AX    2.943382e-06  1.320902e-06  5.049760e-06  0.000010 -2.046755e-07   \n",
      "IOO.AX    1.262204e-06 -4.282892e-07  1.855490e-06  0.000003  4.669536e-07   \n",
      "IVV.AX    1.440659e-06 -8.812980e-07  2.162305e-06  0.000003  7.390313e-07   \n",
      "\n",
      "Security        VSO.AX   VVLU.AX  \n",
      "Security                          \n",
      "A200.AX   5.614930e-07  0.000002  \n",
      "IEU.AX   -9.970485e-08  0.000001  \n",
      "IJP.AX   -6.728589e-08  0.000011  \n",
      "IOO.AX    2.866558e-07  0.000003  \n",
      "IVV.AX    4.219196e-07  0.000004  \n",
      "\n",
      "[5 rows x 21 columns]\n",
      "Security\n",
      "A200.AX    0.143371\n",
      ...
      "max       0.534482\n",
      "dtype: float64\n",
      "Sigma diag min/max: 4.01309681736623e-05 0.0006908426116302578\n",
      "Mkt-RF    0.188673\n",
      "SMB      -0.050877\n",
      "HML       0.013623\n",
      "RMW      -0.053427\n",
   ...
   "source": [
    ...
    "    \n",
    "    # If provided, use the override as the portfolio value, but DO NOT zero out targets\n",
    ...
    "    \n",
    "    # Convert target weights -> target units (rounded)\n",
  ...
  },
  {
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "[debug] tilt_point=(0.06536022520947901, 0.24062989495239112), factor_point=None\n",
      "1 name: Chart 2 | title: Efficient Frontier\n",
      "\n",
      "=== LOT-EXPANDED TABLE ===\n",
      "   Security    AcqDate  UnitsSold    AcqPrice     CostBase  Last Px (AUD)  \\\n",
      "0    IEU.AX 2025-12-15         35  101.480003  3551.800117     103.839996   \n",
      "1    IOO.AX        NaT         42         NaN          NaN     188.449997   \n",
      "2    IVV.AX 2025-12-26         64   68.620003  4391.680176      68.830002   \n",
      "3    IVV.AX 2025-12-29         45   68.599998  3086.999931      68.830002   \n",
      "4   QHAL.AX 2025-12-15          9   52.939999   476.459988      54.270000   \n",
      "5   QHAL.AX 2026-01-12          9   54.340000   489.060001      54.270000   \n",
      "6   QLTY.AX 2025-11-21         28   32.330002   905.240051      33.880001   \n",
      "7   QLTY.AX 2025-12-26         68   33.090000  2250.120010      33.880001   \n",
      "8   QUAL.AX        NaT         91         NaN          NaN      62.880001   \n",
      "9   VDHG.AX 2025-12-15         18   73.790001  1328.220016      74.760002   \n",
      "10   VGE.AX 2025-12-26         10   89.500000   895.000000      91.199997   \n",
      "11   VGS.AX        NaT         51         NaN          NaN     155.070007   \n",
      "12  VLUE.AX        NaT        171         NaN          NaN      34.540001   \n",
      "13  VVLU.AX        NaT         43         NaN          NaN      82.230003   \n",
      "\n",
      "    Cash Flow (AUD)  Brokerage (AUD)  RealisedGain  \n",
      "0       3634.399872             11.0     82.599754  \n",
      "1       7914.899872             11.0           NaN  \n",
      "2       7502.470200             11.0     13.439941  \n",
      "3       7502.470200             11.0     10.350151  \n",
      "4        976.860008             11.0     11.970016  \n",
      "5        976.860008             11.0     -0.629997  \n",
      "6       3252.480103             11.0     43.399979  \n",
      "7       3252.480103             11.0     53.720062  \n",
      "8       5722.080097             11.0           NaN  \n",
      "9       1345.680038             11.0     17.460022  \n",
      "10       911.999969             11.0     16.999969  \n",
      "11      7908.570374             11.0           NaN  \n",
      "12      5906.340157             11.0           NaN  \n",
      "13      3535.890144             11.0           NaN  \n",
      "\n",
      "--- DEBUG: make_trade_plan() ---\n",
      "len(w_target) = 21 sum(w_target) = 1.0\n",
      "nonzero(w_target) = 21\n",
      "w_target head: {'A200.AX': 0.03254425837484474, 'IEU.AX': 0.09559496217544104, 'IJP.AX': 0.0013023492445550793, 'IOO.AX': 0.08026524975731462, 'IVV.AX': 0.06974287896843748}\n",
      "tickers count = 21\n",
      "len(lp_aud) = 21 nan(lp_aud) = 0\n",
      "sum(cur_units) = 3667.0 cur_val (pre-override) = 149828.9111002839\n",
      "portfolio_value_override = None\n",
      "aligned sum(w_target) = 1.0 nan(aligned) = 0 nonzero(aligned) = 21\n",
      "[debug] Current totals → Portfolio: 149828.91, Net Invested: 150449.58\n",
      "[debug] Previous totals → Portfolio: 149828.91, Net Invested: 150449.58\n",
      "[debug] Saved new state → Portfolio: 149828.91, Net Invested: 150449.58\n",
      ...
      "dtype: float64\n",
      "\n",
      "Min mu: 0.12462200009898494\n",
      "Max mu: 0.5344820670816125\n",
      "Mean mu: 0.22415256877563802\n",
   ...
   "source": [
    ...
    "            # Defensive: ensure stale cached rows can’t survive a failed rebuild\n",
    "            charts.pop(\"tilts_comparison_rows\", None)\n",
    "            charts.pop(\"with_tilts_achieved_tilts\", None)\n",
    "\n",
    "            try:\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "OPEN_PPT_AFTER_SAVE = bool(globals().get(\"OPEN_PPT_AFTER_SAVE\", CFG.get(\"open_ppt_after_save\", True)))\n",
    "\n",
    "if bool(globals().get(\"OPEN_AFTER_SAVE\", True)) and bool(globals().get(\"OPEN_EXCEL_AFTER_SAVE\", True)):\n",
    "    _os_open(filename)\n"
   ]
  },
  {
  ...
  },
  {
   ...
   "source": [
    ...
    "        if title:\n",
    "            tb = slide.shapes.add_textbox(left, top - Cm(0.762), width, Cm(0.762))\n",
    "            tf = tb.text_frame\n",
    "            tf.clear()\n",
    "            p = tf.paragraphs[0]\n",
    "            p.text = title\n",
    ...
    "    box = slide.shapes.add_textbox(Cm(1.1), Cm(2.2), Cm(23.0), Cm(0.8))\n",
    "    tf = box.text_frame\n",
    "    tf.clear()\n",
    "    p = tf.paragraphs[0]\n",
    "    p.text = f\"{'☑' if is_with else '☐'} With Tilts    {'☐' if is_with else '☑'} Optimised (No Tilts)    |    Trade plan: {plan_label}\"\n",
    "    p.font.size = Pt(14)\n",
    ...
    "        slide.shapes.add_picture(chart_path, Cm(2.032), Cm(3.302), width=Cm(20.828), height=Cm(11.176))\n",
    "\n",
    ...
    "            plt.close(fig)\n",
    "            \n",
    "            slide4.shapes.add_picture(ff_chart_path, Cm(2.032), Cm(2.921), width=Cm(20.828), height=Cm(9.271))\n",
    "            \n",
